...
const featuredProjects = [
  {
    ...
    description: "Led development of AI-driven customer experiences at Wayfair. Decorify transforms rooms with AI, allowing users to upload images and see them redesigned in seconds with shoppable products. Increased user engagement by 20%+.",
  ...
  },
  {
    ...
    description: "Contributed to Wayfair's main web and mobile applications, shipping features used by millions of global users. Reduced page load times by ~30% through optimized rendering and implemented payment/financing flows improving checkout by 10-15%.",
    ...
    videoUrl: "https://www.youtube.com/embed/1qwJn-_aLxo",
  },
  {
    title: "Demand-IQ SaaS Platform",
    description: "Built and scaled core features for the Demand-IQ SaaS platform supporting thousands of B2B users in demand-generation workflows. Improved dashboard usability reducing task completion time by ~25% and optimized system performance by 20%+.",
    technologies: ["Vue", "Nuxt.js", "TypeScript", "Node.js", "Python", "PostgreSQL"],
    liveUrl: "https://demand-iq.com",
    imageUrl: "/projects/demand-iq.png",
    videoUrl: "https://www.youtube.com/embed/GpzLJ0XEBW4",
  },
  {
    title: "Presidium Health Platform",
    description: "Developed secure healthcare web applications handling sensitive patient and operational data. Implemented APIs and integrations with insurance and provider systems, ensuring HIPAA-compliant security practices.",
    technologies: ["React", "TypeScript", "Node.js", "Python", "Healthcare APIs", "Security"],
